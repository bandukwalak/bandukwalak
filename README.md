...
I'm a bioinformatics student passionate about turning complex biological and clinical data into reproducible, meaningful insights. My work sits at the intersection of **genomics, machine learning, and data engineering** — from cleaning raw biomarker datasets to building NLP-powered clinical tools.
...
| **Data & ML** | Pandas, scikit-learn, statistical modeling, feature selection |
| **Bioinformatics** | BLAST, Phamerator, PECAAN, HPRED |
| **Workflows** | Git, reproducible pipelines, missing data handling, outlier detection |
